...
if ($HpHero): ?>
<div class="hp-hero flex flex-col gap-2 h-[calc(100vh-88px)] mb-2 mt-[72px]">
	...
	<div class="hp-hero__cards md:flex-row flex-col flex gap-2">
		<div class="card card--primary hp-hero__cards__intro flex flex-col gap-4 md:flex-1">
			<div class="subtitle flex items-center justify-between">
				<p class="subtitle__text reveal-text immediate">
					<?php echo $HpHero['hp_hero_subtitle']; ?>
				</p>
				<div class="tag tag--primary scale-up immediate">
					<?php echo $HpHero['hp_hero_subtitle_tag']; ?>
				</div>
			</div>
			<div class="body-m text-highlight blur-text immediate">
		...
		<div class="card card--primary hp-hero__cards__contact flex justify-between md:flex-1">
			<img class="w-16 h-16 image-spin scale-up immediate" src="<?php echo $HpHero['hp_hero_jabba']['url']; ?>" alt="<?php echo $HpHero['hp_hero_jabba']['alt']; ?>"/>
...
if ( $HpServices && !empty($HpServices['hp_services_list']) ): ?>
	<div class="hp-services flex flex-col md:flex-row gap-2 mb-2">
		<div class="card card--primary flex flex-col md:w-[70%] gap-4">
			<div class="subtitle flex items-center justify-between">
				<p class="subtitle__text reveal-text on-scroll">
			...
			<div class="heading-xl text-highlight flex flex-col gap-2">
				<?php foreach( $HpServices['hp_services_list'] as $item ): ?>
					<p class="reveal-text on-scroll"><?php echo esc_html($item['hp_services_list_item']); ?></p>
				<?php endforeach; ?>
			</div>
		</div>
		<div class="card card--primary flex flex-col justify-between gap-4 md:w-[30%]">
			<img class="w-16 h-16 image-spin scale-up on-scroll" src="<?php echo $HpServices['hp_services_icon']['url']; ?>" alt="<?php echo $HpServices['hp_services_icon']['alt']; ?>"/>
			<div class="body-m text-highlight blur-text on-scroll">
...
<div class="card card--primary flex flex-col md:flex-row gap-4 mb-2">
	<div class="md:w-1/2">
		<h3 class="heading-xl text-highlight reveal-text on-scroll">
	...
	<div class="flex flex-col gap-6 md:w-1/2">
		...
		<div class="flex flex-col gap-4">
			<!-- SUBTITLE -->
			<h4 class="heading-m text-highlight reveal-text on-scroll">
				<?php echo $HpPartners['hp_partners_subtitle']; ?>
			</h4>
			<!-- MARQUEE -->
			<div class="partners-marquee overflow-x-hidden">
				<div class="marquee-track gap-2">
					<?php foreach($HpPartners['hp_partners_logos'] as $logo): ?>
					<div class="marquee-item">
						<div class="partners-marquee__card">
						<img class="h-8 w-auto"
							src="<?php echo esc_url($logo['hp_partners_logos_img']['url']); ?>"
							alt="<?php echo esc_attr($logo['hp_partners_logos_img']['alt']); ?>" />
						</div>
					</div>
					<?php endforeach; ?>
				</div>
			...
			<!-- END MARQUEE -->
			<!-- CTA -->
			<a href="<?php echo esc_url($HpPartners['hp_partners_cta']['url']); ?>" class="btn--primary md:w-fit scale-up on-scroll">
