...
<section class="discover-section flex flex-col gap-2">
	...
	<div class="discover_thumbnail w-full rounded-2xl overflow-hidden h-screen">
		<img class="h-full w-full object-cover" src="<?php echo esc_url($discover['discover_image']['url']); ?>" alt="<?php echo esc_attr($discover['discover_image']['alt']); ?>"/>
	</div>
	...
	<div class="card card--primary flex flex-col gap-2">
		<p class="heading-s text-highlight">
