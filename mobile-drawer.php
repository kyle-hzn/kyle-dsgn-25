<?php
	...
	if( $header ): ?>
	<div class="mobile-drawer fixed inset-0 flex items-end w-full h-full md:hidden">
	<div class="mobile-drawer__wrap flex flex-col gap-6 p-2 w-full">
		...
		<div class="flex justify-between">
			<a href="<?php echo esc_url($header['header_linkedin']['url']); ?>" class="btn--link body-m text-highlight p-1">
				<?php echo esc_html($header['header_linkedin']['title']); ?>
			</a>
			<?php if ( !empty($header['header_mail']) ) : ?>
				<a class="btn--link body-m text-highlight px-2" href="mailto:<?php echo esc_attr($header['header_mail']); ?>?subject=Freelance%20Inquiry">
